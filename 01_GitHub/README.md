...
<font color="blue"><i>git config --global user.name "Seu Nome"</i></font>

Configurando o email:<br>
<font color="blue"><i>git config --global user.email "seuemail@email.com.br"</i></font>
...
<font color="blue"><i>git config --global core.editor "comando do editor sem as aspas"</i></font>

Para saber as informações contidas nas configurações do git basta digitar na linha de comando:<br>
<font color="blue"><i>git config --list</i></font>

Caso queira saber apenas um parâmetro especifico, digita-se: <br>
<font color="blue"><i>git config --"parâmetros sem as aspas"</i></font>
...
<font color="blue"><i>cd g:/Meu\ Drive/GitHub/Estudos</i></font>
...
<font color="blue"><i>mkdir GitHub</i></font>
...
<font color="blue"><i>cd GitHub/</i></font>
...
<font color="blue"><i>cd ..</i></font>

E o resultado no caminho do diretório será: <font color="blue"><i>/g/Meu\ Drive/GitHub</i></font>
...
<font color="blue"><i>git init</i></font>
...
<font color="blue"><i>git status</i></font><br>

Serve para reportar como está o repositório.

<font color="blue"><i>git add "nome do arquivo sem as aspas"</i></font><br>
...
<font color="blue"><i>git add .</i></font><br>
...
<font color="blue"><i>git commit -m "Digite seu comentário dentro das aspas"</i></font><br>
...
<font color="blue"><i>git log</i></font><br>
...
<font color="blue"><i>-- decorate</i></font> - que apresenta informações como se o arquivo foi transferido de uma branch para outra, se ocorreu um merge, tags geradas etc.

<font color="blue"><i>-- author="nome"</i></font> - filtra todos os commits de um autor que tenha a palavra "nome" no nome do Autor.

<font color="blue"><i>git shortlog</i></font><br> - Mostra em ordem alfabética a lista dos autores que fizeram commits, quantos commits foram realizados e quais foram esses commits.

<font color="blue"><i>-sn</i></font> - é um parâmetros que pode ser adicionado ao <i>git shortlog</i> que traz um resumo do nome de todos os autores que realizaram commit e a quantidade de cada commit por autor.

<font color="blue"><i>-- graph</i></font> - Mostra em forma gráfica o que esta acontecendo com os branchs e versões.

<font color="blue"><i>git show "número da hash sem as aspas"</i></font> - mostra o que aconteceu com o commit, o que foi adicionado, o que foi removido.

<font color="blue"><i>git diff</i></font><br>
...
<font color="blue"><i>--name-only</i></font> - mostra apenas o nome dos arquivos que tiveram modificações.
