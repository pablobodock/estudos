...
git config --global core.editor "comando do editor sem as aspas"
...
git config --"parâmetros sem as aspas"
...
E o resultado no caminho do diretório será: /g/Meu\ Drive/GitHub
...
<i>git add "nome do arquivo sem as aspas"</i><br>
...
<i>git commit -m "Digite seu comentário dentro das aspas"</i><br>
...
<i>-- decorate</i> - que apresenta informações como se o arquivo foi transferido de uma branch para outra, se ocorreu um merge, tags geradas etc.

<i>-- author="nome" - filtra todos os commits de um autor que tenha a palavra "nome" no nome do Autor.

<i>git shortlog</i><br> - Mostra em ordem alfabética a lista dos autores que fizeram commits, quantos commits foram realizados e quais foram esses commits.

<i>-sn</i> - é um parâmetros que pode ser adicionado ao <i>git shortlog</i> que traz um resumo do nome de todos os autores que realizaram commit e a quantidade de cada commit por autor.

<i>-- graph</i> - Mostra em forma gráfica o que esta acontecendo com os branchs e versões.

<i>git show "número da hash sem as aspas"</i> - mostra o que aconteceu com o commit, o que foi adicionado, o que foi removido.
...
<i>--name-only</i> - mostra apenas o nome dos arquivos que tiveram modificações.
